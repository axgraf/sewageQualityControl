...
class SewageFlag(Flag):
    ...
    BIOMARKER_RATIO_OUTLIER_REMOVED = 128

    ### flow rate flags ###
    SEWAGE_FLOW_NOT_ENOUGH_PREVIOUS_VALUES = 256
    SEWAGE_FLOW_PRECIPITATION = 512
    SEWAGE_FLOW_HEAVY_PRECIPITATION = 1024
    SEWAGE_FLOW_PROBABLE_TYPO = 2048

    ### surrogatvirus flags ###
    SURROGATEVIRUS_VALUE_NOT_USABLE = 4096
    SURROGATEVIRUS_OUTLIER_PMMOV = 8192
    SURROGATEVIRUS_OUTLIER_CRASSPHAGE = 16384

    ### water quality ####
    NOT_ENOUGH_AMMONIUM_VALUES = 32768
    AMMONIUM_OUTLIER = 65536
    NOT_ENOUGH_CONDUCTIVITY_VALUES = 131072
    CONDUCTIVITY_OUTLIER = 262144

    ### biomarker normalization ###
    NOT_ENOUGH_BIOMARKERS_FOR_NORMALIZATION = 524288
    REPRODUCTION_NUMBER_OUTLIER_SKIPPED = 1048576
    REPRODUCTION_NUMBER_OUTLIER = 2097152
