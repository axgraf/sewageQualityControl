...
class SewageFlag(Flag):
    ...
    SEWAGE_FLOW_PRECIPITATION = 256
    SEWAGE_FLOW_HEAVY_PRECIPITATION = 512
    SEWAGE_FLOW_PROBABLE_TYPO = 1024

    ### surrogatvirus flags ###
    SURROGATEVIRUS_VALUE_NOT_USABLE = 2048
    SURROGATEVIRUS_OUTLIER_PMMOV = 4096
    SURROGATEVIRUS_OUTLIER_CRASSPHAGE = 8192

    ### water quality ####
    NOT_ENOUGH_AMMONIUM_VALUES = 16384
    AMMONIUM_OUTLIER = 32768
    NOT_ENOUGH_CONDUCTIVITY_VALUES = 65536
    CONDUCTIVITY_OUTLIER = 131072

    ### biomarker normalization ###
    NOT_ENOUGH_BIOMARKERS_FOR_NORMALIZATION = 262144
    REPRODUCTION_NUMBER_OUTLIER_SKIPPED = 524288
    REPRODUCTION_NUMBER_OUTLIER = 1048576
